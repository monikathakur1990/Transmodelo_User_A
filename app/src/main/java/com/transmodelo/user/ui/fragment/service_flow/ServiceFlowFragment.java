package com.transmodelo.user.ui.fragment.service_flow;
...
import com.transmodelo.user.common.CancelRequestInterface;
...
import com.transmodelo.user.data.network.model.ProviderService;
import com.transmodelo.user.data.network.model.ServiceType;
import com.transmodelo.user.ui.activity.main.MainActivity;
import com.transmodelo.user.ui.fragment.cancel_ride.CancelRideDialogFragment;
...
import static com.transmodelo.user.MvpApplication.showOTP;
...
public class ServiceFlowFragment extends BaseFragment
    ...
    private void initView(Datum datum) {
        ...
        shareRideText = getString(R.string.app_name) + ": "
                + datum.getUser().getFirstName() + " " + datum.getUser().getLastName() + " está viajando en "
                + datum.getServiceType().getName() + " le gustaría compartir el viaje "
