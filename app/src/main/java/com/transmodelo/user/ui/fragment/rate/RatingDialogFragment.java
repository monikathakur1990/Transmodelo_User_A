...
import com.transmodelo.user.base.BaseBottomSheetDialogFragment;
...
import static com.transmodelo.user.chat.ChatActivity.chatPath;
...
public class RatingDialogFragment extends BaseBottomSheetDialogFragment implements RatingIView {
    ...
    public void onSuccess(Object object) {
        ...
        if (!TextUtils.isEmpty(chatPath))
            FirebaseDatabase.getInstance(AppConstant.FIREBASE_URL).getReference().child(chatPath).removeValue();
    }
