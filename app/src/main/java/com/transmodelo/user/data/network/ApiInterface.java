package com.transmodelo.user.data.network;
...
import com.transmodelo.user.data.network.model.Coupon;
...
import com.transmodelo.user.data.network.model.Rental;
...
public interface ApiInterface {
    ...
    @GET("nearbysearch/json?key=AIzaSyCRLa4LQZWNQBcjCYcIVYA45i9i8zfClqc&sensor=true&radius=50&types=point_of_interest")
    ...
    Call<ArrayList<BannerModel>> getBanners();
    @FormUrlEncoded
    ...
    @FormUrlEncoded
    @POST("api/user/card")
    Observable<Object> card(@Field("cardIssuer") String cardIssuer, @Field("token") String token, @Field("cardInfo") String cardInfo);
