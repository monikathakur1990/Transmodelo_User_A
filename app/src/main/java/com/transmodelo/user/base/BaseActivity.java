package com.transmodelo.user.base;
...
import com.transmodelo.user.common.ConnectivityReceiver;
import com.transmodelo.user.common.Constants;
import com.transmodelo.user.common.CustomDialog;
import com.transmodelo.user.common.LocaleHelper;
import com.transmodelo.user.data.SharedHelper;
import com.transmodelo.user.ui.activity.onboard.OnBoardActivity;
import com.transmodelo.user.ui.activity.login.EmailActivity;
import com.transmodelo.user.ui.activity.login.PasswordActivity;
import com.transmodelo.user.ui.activity.register.RegisterActivity;
import com.transmodelo.user.ui.activity.social.SocialLoginActivity;
...
//            i.putExtra(Intent.EXTRA_TEXT, "Hola Mira esta aplicación," +appName + "\nhttps://play.google.com/store/apps/details?id="+BuildConfig.APPLICATION_ID);
    ...
    public void handleError(Throwable e) {
        try {
            ...
            Log.e("handleError1: ",e1.getMessage() );
            e1.printStackTrace();
        }
